...
import com.house.common.enums.TypeEnum;
import com.house.exception.CheckException;
import com.house.mapper.WarnAddressMapper;
...
//                new HandleProcessor().addressProcess(span, addressList); //本地测试用
            ...
            for (String s : addressList) {
                ...
                try {
                    ...
                    throw new CheckException("addressArray数组解析出错");
                }
            }
        }
...
//        String wechatUrl = "https://mp.weixin.qq.com/s/HTM47mUp0GF-tWXkPeZJlg";
        ...
        String wjwUrl = "https://mp.weixin.qq.com/s/qFvUyEB-R-GKP7vgKR-c3A";
